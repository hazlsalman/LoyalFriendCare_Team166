...
public class RabiaPage {
    ...
    @FindBy (xpath = "//*[@id=\"tableWithSearch\"]/tbody/tr[1]/td[2]/p/font")
    public WebElement eskiAsiIsmi;

    @FindBy (xpath = "//*[@id=\"tableWithSearch\"]/tbody/tr[10]/td[2]/p/font")
    public WebElement yeniAsiIsmi;

    @FindBy (xpath = "/html/body/div[1]/div[2]/div[1]/div[2]/div/div[1]/div/div[2]/form\n")
    public WebElement tumFormAsiEkleme;
